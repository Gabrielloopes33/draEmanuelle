...
export default function LinksPage() {
    return (
        <main className="min-h-screen relative overflow-hidden">
            {/* Background com múltiplos degradês animados */}
            <div className="fixed inset-0 -z-10">
                {/* Degradê base */}
                <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-[var(--color-navy)] to-slate-900" />
                ...
                <motion.div
                    className="absolute top-[40%] right-[20%] w-[300px] h-[300px] rounded-full opacity-25"
                    style={{
                ...
                {/* Degradê de overlay para suavizar */}
                ...
                <div className="max-w-md mx-auto">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap justify-center gap-2 text-xs">
                            <span className="px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm text-white/80 flex items-center gap-1 border border-white/10">
                            ...
                            return (
                                ...
                                >
                                    <Link
                                        ...
                                        className={`block w-full p-4 rounded-2xl ${link.color} text-white shadow-lg transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl backdrop-blur-sm`}
                                    >
